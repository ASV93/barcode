...
class DNS2D {
     ...
     * @protected
     */
    protected function getBarcodeSVG($code, $title = null, $type, $w = 3, $h = 3, $color = 'black') {
        if (!$this->store_path) {
        ...
        $svg .= "\t" . '<g><text x="50%" y="6%" style="font-size: 10px; font-family: sans-serif;" text-anchor="middle">' . $title ?? env('QRCODE_TITLE','') . '</text></g>' . "\n";
